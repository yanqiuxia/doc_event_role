...
if __name__=='__main__':
    ...
    p.add_argument('--div', default='test', choices=['train', 'dev', 'test'])
    args = p.parse_args()
    ...
    if args.div == 'test':
        ...
        f = open("/home/eleanor/yan.qiuxia/PycharmProjects/doc_event_role/pytorch/data_seq_tag_pairs/" + args.div, "w+")
    else:
        output_examples = all_examples_sample_neg
        f = open("/home/eleanor/yan.qiuxia/PycharmProjects/doc_event_role/pytorch/data_seq_tag_pairs/" + args.div + "_full", "w+")
